...
export const getPresance = async (req, res) => {
    ...
    try{
        ...
        const presances = await Presance.find();
                    ...
                    try{
                        ...
                        if(exitingUser){
                            if(true){
                                ...
                                const presance = await Presance.create({firstName:exitingUser.firstName,lastName:exitingUser.lastName,code:exitingUser.code, subjectName:curretSubject.name,subjectDate:curretSubject.date, date:d, presance:"present"});
